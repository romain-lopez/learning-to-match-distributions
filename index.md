...
1. Semester-long project (60%): anything that builds upon or applies optimal transport or flow matching, in teams of 2–4, presented in class on Dec 7 and written up in four pages. See the [Project Logistics](project) page for requirements, milestones, and deadlines.
