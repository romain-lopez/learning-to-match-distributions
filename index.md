...
1. Semester-long project (50%): anything that builds upon or applies optimal transport or flow matching, in teams of 2–4, presented as a poster in class on Dec 7. See the [Project Logistics](project) page for requirements, milestones, and deadlines.
...
4. Attendance (10%): taken at every session. A role-play seminar only works if the audience is in the room.
