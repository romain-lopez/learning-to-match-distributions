...
Every paper is covered by **four students**, each taking a different role from the five
...
newer paper that cites this one. Then step back: why did this paper happen when and
...
- Every student presents **around four times** during the semester. With 18 papers
  and four roles for each, there are 72 panel slots to spread across the class.
...
- **Deadlines.** Material submitted after 11 AM may not be loaded in time for the
  ...
  up for, that appearance scores zero.
...
participation in the sessions where you are not presenting.
